...
const userValidator = {
    ...
    edit: [
        body('firstName').isAlpha().withMessage('The first name must contain only letters, not numbers').bail()
        .isLength({
            min: 2
        }).withMessage('The first name must have more than 2 characters'),
        body('lastName').isAlpha().withMessage('The last name must contain only letters, not numbers').bail()
        .isLength({
            min: 2
        }).withMessage('The last name must have more than 2 characters'),
